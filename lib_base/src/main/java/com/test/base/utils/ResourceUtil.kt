...
object ResourceUtil {
    ...
    fun getDrawable(drawId: Int) : Drawable? {
        return ContextCompat.getDrawable(AppManager.getContext(), drawId)
    }
    ...
    fun getColor(colorId: Int) : Int {
        return ContextCompat.getColor(AppManager.getContext(), colorId)
    }
    ...
    fun getAssetsStramByName(fileName: String, context: Context = AppManager.getContext()): InputStream? {
        return try {
            ...
            Logger.e("Resource", "assetsFile", e)
            null
        }
    }
...
///** 默认队伍logo图标*/
//fun getTeamLogoIcon() : Int {
//    return R.drawable.big_head_default
//}
//
///** 默认选手头像图标*/
//fun getPeoHeadIcon() : Int {
//    return R.drawable.peo_head_icon
//}
//
///** 默认空白站位图图标*/
//fun getBlankIcon() : Int {
//    return R.drawable.info_default_icon
//}
